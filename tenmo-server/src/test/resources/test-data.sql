...
CREATE TABLE transfer (
	...
	CONSTRAINT FK_transfer_account_from FOREIGN KEY (account_from) REFERENCES user (user_id),
	CONSTRAINT FK_transfer_account_to FOREIGN KEY (account_to) REFERENCES user (user_id),
